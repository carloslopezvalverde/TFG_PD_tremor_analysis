...
# Leer archivo Excel
df <- read_excel("C:/Users/CARLOS LVS/Desktop/Prácticas INNTEGRA/Estadística/Deltas/delta post24-pre.xlsx")
colnames(df) <- make.names(colnames(df))

# Variables clínicas a analizar
parametros <- c(
  "P_DTF_Delta_POST24_PRE", 
  "BandPower_Delta_POST24_PRE", 
  "RMS_Tremor_Delta_POST24_PRE", 
  "RMS_Robust_Delta_POST24_PRE", 
  "TPR_Delta_POST24_PRE", 
  "Porcentaje_Temblor_Delta_POST24_PRE"
)
